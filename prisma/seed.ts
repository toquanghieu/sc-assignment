...
async function main() {
  const categories = [
    { id: 'SUSHI', name: '스시·해산물' },
    { id: 'UNAGI', name: '장어' },
    { id: 'TEMPURA', name: '덴푸라' },
    { id: 'TONKATSU', name: '돈카츠·쿠시카츠' },
    { id: 'YAKITORI', name: '야키토리·꼬치' },
    { id: 'SUKIYAKI', name: '스키야키·샤브샤브' },
    { id: 'SOBA', name: '소바·우동' },
    { id: 'RAMEN', name: '라멘·츠케멘' },
    { id: 'YAKISOBA', name: '야키소바' },
    { id: 'OKONOMIYAKI', name: '오코노미야키·타코야키' },
    { id: 'DONBURI', name: '덮밥' },
    { id: 'ODEN', name: '오뎅' },
    { id: 'KAISEKI', name: '가이세키·일식' },
    { id: 'HAMBAGU', name: '함바그·오므라이스' },
    { id: 'TEPPANYAKI', name: '스테이크·철판요리' },
    { id: 'CURRY', name: '카레' },
    { id: 'YAKINIKU', name: '야키니쿠·호르몬' },
    { id: 'NABE', name: '나베' },
    { id: 'CAFE', name: '카페·디저트' },
    { id: 'IZAKAYA', name: '이자카야·바' },
    { id: 'OTHER', name: '기타 일본 음식' },
  ];
  await Promise.all(
